...
def build_drcnn(sample_long, output_num):
    input_layer = Input(shape=(1, 2, sample_long), name='input')
    ...
    ouput_layer = Dense(output_num, activation='softmax', name='output')(dense2)
